...
public class DevCommOverride
{
    ...
    public static void MoreSlugcats_ChatlogData_getDevComm(ILContext il) {
        ...
        cursor.EmitDelegate((string[] array2, string path) => {
            if (path.Contains(Plugin.MOD_NAME)) {   // This should match the name of the folder your mod is in, otherwise it will affect all commentary.
                                                            // As in, "StreamingAssets/mods/THIS-NAME-RIGHT-HERE/plugins/your_mod.dll
